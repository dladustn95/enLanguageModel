...
from train_key import SPECIAL_TOKENS, build_input_from_segments, add_special_tokens_
...
def sample_sequence(source, score, bert_tokenizer, model, bert_model, gpt_tokenizer, args, current_output=None):
...
def run():
    ...
    for line in zip(sourceList, targetList, scoreList):
        out_ids = sample_sequence(line[0], line[2], bert_tokenizer, model, bert_model, tokenizer, args)
